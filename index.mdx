...
<div className="usb-hero">
  ...
  <div className="usb-hero__cta">
    ...
    <span className="usb-pill">Sentinel oversight</span>
...
<div className="usb-section">
  ...
  <ol>
    <li><strong>User-first custody.</strong> Wallets stay in control, and every sentinel action is auditable.</li>
    <li><strong>Composability over walled gardens.</strong> We integrate with best-in-class venues instead of re-building them.</li>
    <li><strong>Proof-backed sentinel.</strong> Risk actions are evidenced with verifiable data, not promises.</li>
